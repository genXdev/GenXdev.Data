...
RequiredModules = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.304.2025'; }, 
               @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.304.2025'; })
...
FileList = '.gitignore', 'GenXdev.Data.csproj', 
