...
RequiredModules = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.296.2025'; }, 
               @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.296.2025'; })
...
FunctionsToExport = 'EnsureSQLiteStudioInstalled', 'EnsureSSMSInstalled', 
               ...
               'Get-SQLiteTransaction', 'Get-SQLiteViewColumnData', 
               'Get-SQLiteViewData', 'Get-SQLiteViews', 'Get-SQLiteViewSchema', 
               'Get-SQLServerSchema', 'Get-SQLServerTableColumnData', 
               'Get-SQLServerTableData', 'Get-SQLServerTables', 
               'Get-SQLServerTableSchema', 'Get-SQLServerTransaction', 
               'Get-SQLServerViewColumnData', 'Get-SQLServerViewData', 
               'Get-SQLServerViews', 'Get-SQLServerViewSchema', 'Get-StoreKeys', 
               'Get-ValueByKeyFromStore', 'GetStoreFilePath', 
               'Initialize-KeyValueStores', 'Invoke-SQLiteQuery', 
               'Invoke-SQLiteStudio', 'Invoke-SQLServerQuery', 'Invoke-SSMS', 
               'New-SQLiteDatabase', 'New-SQLServerDatabase', 
...
FileList = 'GenXdev.Data.KeyValueStore.psm1', 'GenXdev.Data.Preferences.psm1', 
               ...
               'Functions\GenXdev.Data.KeyValueStore\GetStoreFilePath.ps1', 
               ...
               'Functions\GenXdev.Data.SqlServer\Get-SQLServerTableColumnData.ps1', 
